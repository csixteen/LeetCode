...
function __promptline {
  ...
  local a_bg="${wrap}48;5;75${end_wrap}"
  local a_sep_fg="${wrap}38;5;75${end_wrap}"
  local b_fg="${wrap}38;5;75${end_wrap}"
  local b_bg="${wrap}48;5;15${end_wrap}"
  local b_sep_fg="${wrap}38;5;15${end_wrap}"
  local c_fg="${wrap}38;5;15${end_wrap}"
  local c_bg="${wrap}48;5;33${end_wrap}"
  local c_sep_fg="${wrap}38;5;33${end_wrap}"
  local warn_fg="${wrap}38;5;196${end_wrap}"
  local warn_bg="${wrap}48;5;15${end_wrap}"
  local warn_sep_fg="${wrap}38;5;15${end_wrap}"
